...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/Cellar/bazel/3.2.0/bin/bazel',
    '/private/var/tmp/_bazel_snehamahapatra/fb0c0714b915bf163d4d6ca7f607aeee/execroot/mediapipe',
    'ios_x86_64',
    {
        'watchos_armv7k': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/snehamahapatra/Library/Application Support/Tulsi/0.20190814.88/Bazel',
