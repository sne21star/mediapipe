//
//  ViewControllerPhrase.m
//  Mediapipe
//
//  Created by Sneha Mahapatra on 10/7/20.
//
...
@interface ViewControllerPhrase () <MPPGraphDelegate, MPPInputSourceDelegate>
...
@implementation ViewControllerPhrase {
